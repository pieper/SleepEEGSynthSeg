...
# ------------------------------------------------------------------------------
def loadSeriesByUID(seriesUIDs, pluginClassNames=None):
    ...
    loadablesByPlugin, loadEnabled = getLoadablesFromFileLists(fileLists, pluginClassNames=pluginClassNames)
...
def getLoadablesFromFileLists(fileLists, pluginClassNames=None, messages=None, progressCallback=None, pluginInstances=None):
    ...
    for step, pluginClassName in enumerate(pluginClassNames):
        print(10*f"{step} trying {pluginClassName}\n")
